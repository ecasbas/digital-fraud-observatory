...
def case_page(c):
    ...
    if c['kind'] == 'capture':
        ...
        figure = f'''<figure class="evidence-figure"><div class="incident-full"><div class="incident-step"><span>1</span><strong>{E(c['claim'])}</strong><p>Request appears to come through an official channel.</p></div><div class="incident-step incident-warning"><span>2</span><strong>{E(c['counterclaim'])}</strong><p>Requester identity, legal authority and scope need independent confirmation.</p></div><div class="incident-step"><span>3</span><strong>Data disclosure risk</strong><p>Sensitive records can leave through a normal compliance process.</p></div></div><figcaption class="figure-caption">Documented public incident. No live system or private customer record is embedded here.</figcaption></figure>'''
